<?php
    ...
    $n1_quim = $listagem['n1_quim'];
    $n2_quim = $listagem['n2_quim'];
    $n3_quim = $listagem['n3_quim'];
    $n4_quim = $listagem['n4_quim'];
    $medi_quim = $listagem['medi_quim'];

    $n1_fisi = $listagem['n1_fisi'];
    $n2_fisi = $listagem['n2_fisi'];
    $n3_fisi = $listagem['n3_fisi'];
    $n4_fisi = $listagem['n4_fisi'];
    $medi_fisi = $listagem['medi_fisi'];
...
<body>
    ...
    <main class="corpo-principal">
        ...
        <form action="" method="get">
            <div class="conteiner-input-edição-notas">
                ...
                <!-- CONTEINER QUIMICA -->
                <div class="conteiner-edit-quimica">
                    <div class="conteiner-titulo">
                        <h3 class="t1 text1">QUIMICA</h3>
                    </div>
                    ...
                    <div class="conteiner-input-3">
                        ...
                        <div class="div-input-3">
                            ...
                            <input class="text1 input-val n1-quim-val" type="number" disabled value="<?php echo $n1_quim ?>">

                            <input class="input-3 n1-quim" type="number" name="n1-quim" placeholder="n1" id="campo-1-quim" required step="any" value="<?php echo $n1_quim ?>">
                        </div>
                        <div class="div-input-3">
                            <label class="text1" for="n2-quim">NOTA 2:</label>
                            <input class="text1 input-val n2-quim-val" type="number" disabled value="<?php echo $n2_quim ?>">

                            <input class="input-3 n2-quim" type="number" name="n2-quim" placeholder="n2" id="campo-2-quim" required step="any" value="<?php echo $n2_quim ?>">
                        </div>
                        <div class="div-input-3">
                            <label class="text1" for="n3-quim">NOTA 3:</label>
                            <input class="text1 input-val n3-quim-val" type="number" disabled value="<?php echo $n3_quim ?>">

                            <input class="input-3 n3-quim" type="number" name="n3-quim" placeholder="n3" id="campo-3-quim" required step="any" value="<?php echo $n3_quim ?>">
                        </div>
                        <div class="div-input-3">
                            <label class="text1" for="n4-quim">NOTA 4:</label>
                            <input class="text1 input-val n4-quim-val" type="number" disabled value="<?php echo $n4_quim ?>">

                            <input class="input-3 n4-quim" type="number" name="n4-quim" placeholder="n4" id="campo-4-quim" required step="any" value="<?php echo $n4_quim ?>">
                        </div>
                        <div class="div-input">
                            <div class="medias-edit">
                                <label class="text1 legenda-media"  for="media">MEDIA:</label>
                                <div class="conteiner-medias-edit">
                                    <label class="text1">ANTIGA</label>
                                    <h3 class="text1"> <?php echo $medi_quim ?> </h3>
                                </div>
                                <div class="conteiner-medias-edit" >
                                    <label class="text1">NOVA</label>
                                    <h3 class="media-3">0</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- CONTEINER FISICA -->
                <div class="conteiner-edit-fisica">
                    <div class="conteiner-titulo">
                        <h3 class="t1 text1">FISICA</h3>
                    </div>
                    ...
                    <div class="conteiner-input-3">
                        ...
                        <div class="div-input-3">
                            ...
                            <input class="text1 input-val n1-fisi-val" type="number" disabled value="<?php echo $n1_fisi ?>">

                            <input class="input-3 n1-fisi" type="number" name="n1-fisi" placeholder="n1" id="campo-1-fisi" required step="any" value="<?php echo $n1_fisi ?>">
                        </div>
                        <div class="div-input-3">
                            <label class="text1" for="n2-fisi">NOTA 2:</label>
                            <input class="text1 input-val n2-fisi-val" type="number" disabled value="<?php echo $n2_fisi ?>">

                            <input class="input-3 n2-fisi" type="number" name="n2-fisi" placeholder="n2" id="campo-2-fisi" required step="any" value="<?php echo $n2_fisi ?>">
                        </div>
                        <div class="div-input-3">
                            <label class="text1" for="n3-fisi">NOTA 3:</label>
                            <input class="text1 input-val n3-fisi-val" type="number" disabled value="<?php echo $n3_fisi ?>">

                            <input class="input-3 n3-fisi" type="number" name="n3-fisi" placeholder="n3" id="campo-3-fisi" required step="any" value="<?php echo $n3_fisi ?>" >
                        </div>
                        <div class="div-input-3">
                            <label class="text1" for="n4-fisi">NOTA 4:</label>
                            <input class="text1 input-val n4-fisi-val" type="number" disabled value="<?php echo $n4_fisi ?>">

                            <input class="input-3 n4-fisi" type="number" name="n4-fisi" placeholder="n4" id="campo-4-fisi" required step="any" value="<?php echo $n4_fisi ?>">
                        </div>
                        <div class="div-input">
                            <div class="medias-edit">
                                <label class="text1 legenda-media"  for="media">MEDIA:</label>
                                <div class="conteiner-medias-edit">
                                    <label class="text1">ANTIGA</label>
                                    <h3 class="text1"> <?php echo $medi_fisi ?> </h3>
                                </div>
                                <div class="conteiner-medias-edit" >
                                    <label class="text1">NOVA</label>
                                    <h3 class="media-4">0</h3>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="comandos/comandos_edita_med.js"></script>
</body>
</html>